...
public class CustomMuPDFActivity extends Activity implements FilePicker.FilePickerSupport {
    ...
    */
    ...
    public void OnMoreButtonClick(View v) {
        ...
        if (core != null) {
            ...
            Intent intent = new Intent(CustomMuPDFActivity.this, PDFPreviewGridActivity.class);
